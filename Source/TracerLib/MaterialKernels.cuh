...
// 
template<class UVList, class MGroup>
using OutputUVsFunc = (// Output
                       UVList&,         // Holds gMem pointers for uvs (Type depends on implementation)
                       // Input
...
using ShadeFunc2 = Vector3(*)(// Sampled Output
                              RayF& wo,
                              float& pdf,
                              // Input
