                               ...
                               GenerateAABBTriangle, GenerateAreaTriangle>
{
    ...
    public:
        ...
        SceneError                              InitializeGroup(const std::set<SceneNodeI>& surfaceDataNodes, double time) override;
        SceneError                              ChangeTime(const std::set<SceneNodeI>& surfaceDataNodes, double time) override;
