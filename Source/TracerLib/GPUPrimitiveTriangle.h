                               ...
                               GenerateAABBTriangle, GenerateAreaTriangle>
{
    ...
    public:
        ...
        SceneError                              InitializeGroup(const NodeListing& surfaceDataNodes, double time) override;
        SceneError                              ChangeTime(const NodeListing& surfaceDataNodes, double time) override;
