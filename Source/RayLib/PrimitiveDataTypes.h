...
static constexpr const char* PrimitiveDataLayoutNames[static_cast<size_t>(PrimitiveDataLayout::END)] =
{
    "HALF_1",
    "HALF_2",
    "HALF_3",
...
static_assert(sizeof(PrimitiveDataLayoutNames) / sizeof(const char*) ==
              static_cast<int>(PrimitiveDataLayout::END), "String array and enum count mismatch.");

static constexpr size_t PrimitiveLayoutSizes[static_cast<size_t>(PrimitiveDataLayout::END)]
{
    // Float Data Types
...
static_assert(sizeof(PrimitiveLayoutSizes) / sizeof(size_t) ==
              static_cast<int>(PrimitiveDataLayout::END), "size_t array and enum count mismatch.");

static constexpr const char* PrimitiveDataLayoutToString(PrimitiveDataType t)
{
    return PrimitiveDataTypeNames[static_cast<int>(t)];
}
